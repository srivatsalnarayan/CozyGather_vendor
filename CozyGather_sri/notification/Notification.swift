...
struct Notification: View {
    var body: some View {
        VStack(spacing: 20) {
            ...
            CustomNotificationBox(imageName: "noti1", date: "January 25, 2024", description: "Hi.", timeButtonText: "")
                .padding()
                .position(CGPoint(x: 210.0, y: -250.0))
                .frame(width: 430, height: 10)

            CustomNotificationBox(imageName: "noti2", date: "February 2, 2024", description: "Hello.", timeButtonText: "")
                .padding()
